...
parser.add_argument('-lambda', '--lambda', dest='lamb', type=float, default=0.8, help='Value of lambda')
...
parser.add_argument('-al', '--alpha', dest='alpha', type=float, default=0.8, help='Learning Rate')
